...
use queries::{
    ...
    GetDiscountNodes, GetFulfillmentOrders, GetGiftCards, GetInventoryItem, GetInventoryItems,
    ...
    InventoryAdjustQuantities, InventorySetQuantities, MoveInventory, OrderCancel, OrderCapture,
    OrderClose, OrderEditAddCustomItem, OrderEditAddLineItemDiscount, OrderEditAddShippingLine,
