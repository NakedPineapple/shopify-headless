        ...
        Self {
            ...
            slides: vec![
                ...
                HeroSlide {
                    ...
                    image_url: "/static/images/original/hero/hero-self-love.png".to_string(),
                ...
                HeroSlide {
                    ...
                    image_url: "/static/images/original/hero/hero-glow-better.png".to_string(),
                ...
                HeroSlide {
                    ...
                    image_url: "/static/images/original/hero/hero-tennis.png".to_string(),
                ...
                HeroSlide {
                    ...
                    button_url: Some("/collections/frontpage".to_string()),
                    image_url: "/static/images/original/hero/hero-pickleball.png".to_string(),
                ...
                HeroSlide {
                    ...
                    image_url: "/static/images/original/hero/hero-holding-product.png".to_string(),
...
fn get_featured_reviews() -> Vec<ReviewView> {
    vec![
        ReviewView {
            ...
            product_image_url: Some("/static/images/original/products/pineapple-enzyme-cleanser/main.jpg".to_string()),
        },
        ReviewView {
            ...
            product_image_url: Some("/static/images/original/products/starter-kit/main.jpg".to_string()),
        },
        ReviewView {
            ...
            product_image_url: Some("/static/images/original/products/skin-tight-exotic-cream/main.jpg".to_string()),
        },
        ReviewView {
            ...
            product_image_url: Some("/static/images/original/products/pineapple-facial-oil/main.jpg".to_string()),
        },
    ]
}
