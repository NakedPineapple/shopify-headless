...
pub static IMAGE_INFO: LazyLock<HashMap<&'static str, ImageInfo>> = LazyLock::new(|| {
    HashMap::from([
        ...
        ("favicon/android-chrome-192x192", ("86adcd75", 0)),
        ("favicon/android-chrome-512x512", ("2f4a0ce5", 0)),
        ("favicon/apple-touch-icon", ("bffd02d1", 0)),
        ("favicon/favicon", ("7d07ced1", 0)),
        ("favicon/favicon-16x16", ("bd3b4f2e", 0)),
        ("favicon/favicon-32x32", ("7ecfc806", 0)),
